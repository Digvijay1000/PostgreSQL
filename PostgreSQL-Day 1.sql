...
2.  Alphabetically, numerically, chronologically(count(*),aggregation, subqueries) etc
...
> Used to SELECT the DISTINCT(unique) values in a table
...
-- Example Multiple columns (pair of column would be in the form of distinct value)
SELECT DISTINCT
first_name,
last_name
FROM actor
...
-- Multiple columns
SELECT DISTINCT
first_name, -- Note: Distinct in terms of all selected columns(first_name, last_name)!
last_name
FROM actor
ORDER BY first_name
LIMIT 9;
